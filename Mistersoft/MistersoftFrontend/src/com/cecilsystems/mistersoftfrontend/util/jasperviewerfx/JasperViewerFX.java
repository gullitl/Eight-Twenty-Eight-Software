 ...
 */
package com.cecilsystems.mistersoftfrontend.util.jasperviewerfx;
...
public class JasperViewerFX {
    ...
    private Scene createScene() {
        ...
        // Menu's buttons
        print = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/printer.png"));
        save = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/save.png"));
        backPage = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/backimg.png"));
        firstPage = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/firstimg.png"));
        nextPage = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/nextimg.png"));
        lastPage = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/lastimg.png"));
        zoomIn = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/zoomin.png"));
        zoomOut = new Button(null, new ImageView("/com/cecilsystems/mistersoft/util/jasperviewerfx/icons/zoomout.png"));
